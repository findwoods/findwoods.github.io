...
# 定义顶层目录的期望顺序
PREDEFINED_ORDER = ["1笔记知识库", "线性代数", "MQST", "QCQI", "MathODE", "PhysLab", "ChemLab", "PhysChem", "OrgChem1", "PhysChem1", "Atkins", "PhysAnaChemLab", "APP", "IBM", "时间序列", "高级编程Advanced Programming", "计算机系统Fundies", "计算机理论CST", "现代代数morden algebra"]
